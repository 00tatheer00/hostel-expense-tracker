...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-border/70 bg-card/85 backdrop-blur-md text-card-foreground shadow-card transition-all duration-200 hover:shadow-lg hover:border-border",
      className
    )}
    {...props}
  />
