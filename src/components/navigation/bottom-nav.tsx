...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden border-t border-border/80 bg-background/95 backdrop-blur-lg pb-safe">
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "relative flex flex-1 flex-col items-center justify-center py-2 text-[11px] font-medium transition-colors",
                isActive
